...
const unsigned char PROGMEM chichi_15x14[] = {
15, 14,
0x18, 0x0c, 0xf6, 0xfa, 0x7c, 0xbc, 0xdd, 0xdd, 0xbd, 0xbd, 0x7c, 0x7c, 0xfc, 0xf8, 0xf0, 
0x00, 0x00, 0x06, 0x1e, 0x38, 0x3f, 0x3f, 0x39, 0x3f, 0x3f, 0x2f, 0x29, 0x3e, 0x3e, 0x18, 
};

const uint8_t PROGMEM cuss_14x14[] = {
14, 14,
0xf8, 0xfc, 0xde, 0x0f, 0xe7, 0xf7, 0xff, 0xff, 0xf7, 0xe7, 0x0f, 0xde, 0xfc, 0xf8, 
0x07, 0x0f, 0x1f, 0x00, 0x3f, 0x31, 0x38, 0x38, 0x31, 0x3f, 0x00, 0x1f, 0x0f, 0x07, 
};

const uint8_t PROGMEM kiss_14x14[] = {
14, 14,
0xf8, 0xfc, 0xfe, 0xff, 0xc7, 0xff, 0xff, 0xff, 0xff, 0xc7, 0xff, 0xfe, 0xfc, 0xf8, 
0x07, 0x0f, 0x1c, 0x38, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x38, 0x1c, 0x0f, 0x07, 
};
...
void loop() {
  ...
  switch (gameMode) {
    ...
    case 3:
      ...
      } else if (cuddleCounter>30 && cuddleCounter < 85) {
      ...
      } else if (cuddleCounter>84 && cuddleCounter < 108) {
        tinyfont.print("I love you");
      } else if (cuddleCounter==109) {
        superHappyCounter = 100;
        score += 50;
        catMorale = 3;
        gameMode = 0;
